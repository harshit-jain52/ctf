...
Uncover the appropriate plaintext and submit the flags below!
```

1. Do you know what all these ones and zeros mean?
...
5. Uppercase letters and digits in a long stream.... notice anything about the padding?
    ...
    ```shell
    echo "I5XW6ZBAO5XXE2ZBEBKGQYLUEB3WC4ZAIJQXGZJAGMZCYIDPMZ2GK3RAOVZWKZBA
...
6. A mixed alphabet with symbols. What is this one supposed to be?
    ...
    Tried different bases on Cyberchef; Base45 worked.

7. Compact and common on the wire... does the ending give you a clue?

    ```shell
    echo "V2VsbCBkb25lISBUaGF0IHdhcyBCYXNlIDY0LCBzdXBlciBjb21tb24gZm9yIGVuY29kaW5nIGRh
    ...
    bGFnOiBmbGFne2NkMDE2NGZmNjQ3MjZmMjk3MmIyZDhmMmFjMDExOWRifQ==" | base64 -d
    ```
...
8. This variant often shows special markers. See anything bracketing the data?
    ...
    decoded_message = base64.a85decode(message[3:-3])
...
9. This noisy alphabet is picky about whitespace... formatting might matter!
    ...
    Remove linebreaks and then decode from Base92 on Cyberchef
...
10. The data below looks super weird! Don't panic if your editor can't render every symbol. Can you tell what it is?
    ...
    print(base65536.decode(message.replace("\n", "")))
    ```
